...
public class PDFReportTest {
    ...
    public PDFReportTest(File file) {
    ...
    public void generatePDF() throws Exception{
        PdfPTable table = createTable(16);
        table.addCell(createCell("学生信息列表：", keyfont,Element.ALIGN_LEFT,16,false));
        ...
        for(int i=0;i<5;i++){
            table.addCell(createCell("姓SDS实打实大苏打实打实大苏打实打实名"+i, textfont));
    ...
    public static void main(String[] args) throws Exception {
        File file = new File("C:\\Users\\chenny\\Desktop\\text.pdf");
        file.createNewFile();
        new PDFReportTest(file).generatePDF();
    }
